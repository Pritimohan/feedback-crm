...
/** Calendar days after `now` when Fitelo hits MAX_ATTEMPTS_PER_DAY same-day busy/no-answer (e.g. 1st → 4th at NEXT_DAY_RETRY_HOUR). */
export const FITTELO_RETRY_DAYS_AFTER_DAILY_CAP = 3;
